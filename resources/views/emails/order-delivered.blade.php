...
@section('content')
    ...
    <p style="margin-top:24px;">
        <a href="https://wa.me/{{ \App\Models\Setting::whatsappNumber() }}" style="background-color:#3e999a;color:#ffffff;padding:10px 20px;border-radius:6px;text-decoration:none;display:inline-block;">
            Chat on WhatsApp
        </a>
    </p>
@endsection
